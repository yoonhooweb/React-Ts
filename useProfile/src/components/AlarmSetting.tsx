            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm">
                ...
                <div className="space-y-4">
                    <label className="flex items-center justify-between">
                        <span className="text-gray-700 dark:text-gray-300 capitalize">이메일 알림</span>
                        {/* On: bg-blue-500 */}
                    ...
                    <label className="flex items-center justify-between">
                        <span className="text-gray-700 dark:text-gray-300 capitalize">푸시 알림</span>
                        {/* On: bg-blue-500 */}
                        {/* Off: bg-gray-300 dark:bg-gray-600 */}
                        <button className="relative inline-flex h-6 w-11 items-center rounded-full transition-colors bg-gray-300 dark:bg-gray-600">
                            {/* On: translate-x-6  */}
                    ...
                    <label className="flex items-center justify-between">
                        <span className="text-gray-700 dark:text-gray-300 capitalize">데스크톱 알림</span>
                        {/* On: bg-blue-500 */}
                        {/* Off: bg-gray-300 dark:bg-gray-600 */}
                        <button className="relative inline-flex h-6 w-11 items-center rounded-full transition-colors bg-gray-300 dark:bg-gray-600">
                            {/* On: translate-x-6  */}
