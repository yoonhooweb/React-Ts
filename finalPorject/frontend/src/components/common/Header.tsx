        ...
        <header className='bg-slate-900 text-white py-5 px-4 md:px-8'>
            <div className='max-w-7xl mx-auto flex items-center justify-between'>
                ...
                <div className='flex items-center space-x-4'>
                    ...
                    <Link to='/create-post' className='p-1.5 bg-blue-500 rounded-full hover:bg-blue-600 transition-colors'>
                        <PenSquare className='h-4 w-4' />
                    </Link>
                    {!isLogin && (
                        <Link to='/auth/login' className='p-1.5 bg-slate-800 rounded-full hover:bg-slate-700 transition-colors'>
